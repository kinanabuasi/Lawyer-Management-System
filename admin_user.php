				...
				<div class="d-flex" id="wrapper">
					...
					<div class="bg-light border-right" id="sidebar-wrapper">
						...
						<a href="admin_dashboard.php" class="list-group-item list-group-item-action bg-light">Dashboard</a><!--this page-->
							<a href="Add_service.php" class="list-group-item list-group-item-action bg-light">إضافة خدمة</a><!--Add_service page-->
							<a href="admin_lawyers_orders.php" class="list-group-item list-group-item-action bg-light">طلبات المحامين  <span id="notificationCounter"
                            class="notification-badge"><?php echo $notificationCount; ?></span></a><!--Add_service page-->
							<a href="admin_lawyer.php" class="list-group-item list-group-item-action bg-light">عرض قائمة المحامين</a><!--admin_lawyer page-->
							<a href="admin_user.php" class="list-group-item list-group-item-action bg-light">عرض قائمة المستخدمين</a><!--admin_user page-->
						</div>
					</div>
					<!-- /#sidebar-wrapper -->
