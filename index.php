...
<body>
                ...
                <div class="row">
                    <div class="col-md">
                        <div class="banner_content">
                            <h1 style="margin-bottom: 20px;">Find Your Suitable Lawyer Here!</h1>
                            <a href="searchLawyer.php" class="btn-lg cusbutton">Find Lawyers</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="lawyerscard" style="margin-top: 20px;">
        <div class="container">
            <div class="row">
                <?php
                ...
                <div class="col-md-4">
                    <div class="card" style="width: 18rem;">
                        <img src="images/upload/<?php echo $row["image"]; ?>" class="card-img-top cusimg img-fluid"
                            alt="img">
                        <div class="card-body">
                            <h5 class="card-title"><?php echo $row["first_Name"]; ?> <?php echo $row["last_Name"]; ?>
                            </h5>
                            <!--lawyers name dynamic-->
                            <h6 class="card-title"><?php echo $row["speciality"]; ?></h6>
                            <!--lawyers practice speciality dynamic-->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 ml-auto">
                    <h1>About US</h1>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Explicabo debitis magni minus neque,
                        sit culpa, placeat velit aperiam ea sunt eaque vitae consectetur adipisicing elit. Explicabo
                        debitis magni minus neque, sit culpa, placeat velit aperiam ea sunt eaque vita similique iusto
                        temporibus nihil ducimus repellendus alias eos!</p>
                ...
                <div class="col-md-6">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4819.666997906528!2d90.382497577668!3d23.752560532065658!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b8afb693ff75%3A0x32051f5a37ac6420!2sDaffodil+International+Academy!5e0!3m2!1sen!2sbd!4v1554892042236!5m2!1sen!2sbd"
