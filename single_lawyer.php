                    ...
                    <div class="mainprofile">
                        ...
                        <form action="save_booking.php" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                <label for=" Book for appointment"><b> Book for appointment:</b></label>
                            </div>
                                ...
                                <div class="col-md-3">
                                    <textarea name="description" id="" cols="40" rows="6"
                                        placeholder="Write a description, if any"></textarea>
                                </div>
                                <div class="col-md-3 float-right">
                                    ...
                                    <?php } else { ?>
                                    <h6><a href="login.php">To request a lawyer booking, please login or register
                                            first</a></h6>
                                    <?php } ?>
                                </div>
                            </div>
