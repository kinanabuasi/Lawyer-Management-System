...
<body>
    ...
    <body>
        <section class="lawyerscard">
            <div class="container">
                <form action="searchLawyer.php" method="post" novalidate="novalidate">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group ">
                            ...
                            <select id="city" name="city" class="form-control">
                                ...
                                <option value="AlRyad">AlRyad</option>
                            </select>
                            </div>
                        </div>
                    </div>
...
if (isset($_POST['submit'])) {
    ...
    $query = "SELECT * FROM user JOIN lawyer ON lawyer.lawyer_id = user.u_id";
    $conditions = array();

    if (! empty($speciality)) {
        $conditions[] = "lawyer.speciality = '$speciality'";
        // echo " condition 2 ";
    }

    if (! empty($experience)) {
        $conditions[] = "lawyer.practise_Length = '$experience'";
        // echo " condition 1 ";
    }

    if (!empty($city)) {
        $conditions[] = "lawyer.city = '$city'";
        // echo " condition 3 ";
    }
                        ...
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><?php echo $row["first_Name"]; ?>
                                    <?php echo $row["last_Name"]; ?></h5>
                                <!--lawyer's name dynamic-->
                                <h6 class="card-title"><?php echo $row["speciality"]; ?></h6>
                                <!--lawyer's practice speciality dynamic-->
                                <h6 class="card-title"><span><?php echo $row["practise_Length"]; ?></span></h6>
                                <!--lawyer's practice time dynamic-->
