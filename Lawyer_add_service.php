    ...
    <body>
        <div class="d-flex" id="wrapper">
            <div class="bg-light border-right" id="sidebar-wrapper">
                <div class="list-group-item list-group-item-action bg-light">My Profile</div>
                <div class="list-group list-group-flush">
                    ...
                    <a href="lawyer_booking.php" class="list-group-item list-group-item-action bg-light">طلبات
                        ...
                        <span id="notificationCounter"
                            class="notification-badge"><?php echo $notificationCount_r; ?></span>
                    </a>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6" style="margin-top: 50px; margin-bottom: 100px;">
                            <form action="add_service_controller.php" method="POST" enctype="multipart/form-data"
                                id="validateForm">
